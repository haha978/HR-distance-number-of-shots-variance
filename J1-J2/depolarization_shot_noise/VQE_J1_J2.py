...
def get_args(parser):
    ...
    parser.add_argument('--J2', type = float, default = 0.2, help = "strength of next nearest neighbor coupling(default J: 0.2)")
...
def main(args):
    ...
    plt.savefig(args.output_dir+'/'+  str(n_qbts)+"qubits_"+ str(args.n_layers)+f"layers_shots_{args.shots}_p1_{args.p1}_p2_{args.p2}.png", dpi = 300, bbox_inches='tight')
